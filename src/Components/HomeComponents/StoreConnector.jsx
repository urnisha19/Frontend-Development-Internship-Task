  ...
  return (
    <div className="flex flex-col items-center min-h-screen bg-white mt-16 px-4">
      ...
      <p className="text-base md:text-lg text-gray-500 mb-12 text-center">
        Designify easily integrates with major e-commerce platforms and
        marketplaces
      </p>

      {/* Central Hub and Grid Layout */}
      <div className="relative grid grid-cols-3 grid-rows-3 gap-8 md:gap-12 lg:gap-16 justify-items-center items-center w-full max-w-[500px] md:max-w-[600px] lg:max-w-[700px] h-[350px] md:h-[450px] lg:h-[500px]">
        {/* Top Left - BigCommerce */}
        <a
          href="/"
          className="w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 rounded-lg flex justify-center items-center shadow-md transform transition-transform duration-300 hover:scale-110"
        >
          <img
        ...
        <div
          className="w-24 h-24 md:w-32 md:h-32 lg:w-40 lg:h-40 rounded-full flex justify-center items-center shadow-lg"
          data-aos="zoom-out"
        >
          <img
            src={DesignifyLogo}
